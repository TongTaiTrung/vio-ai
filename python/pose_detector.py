...
def analyze(sample_video, student_video, studentCode, skip_frames=1, max_frames=300):
    ...
    Args:
        sample_video: str, path to sample video
        student_video: str, path to student video
        skip_frames: int, frames to skip
        max_frames: int, max frames to process
    Returns:
        result: dict with scores, angles, and report URLs
    """
    ...
    # Detect if student video is flipped
